...
exports.list = async (req, res, next) => {
  try {
    const {firstname, lastname, email, companyId, sites, page = 1, perPage = 25, login_as = 'COMPANY_CLIENT'} = req.query;
    const options = omitBy({ firstname,  lastname, email, companyId, sites, login_as}, isNil);
