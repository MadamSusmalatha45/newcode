...
const shiftSchema = new mongoose.Schema({
 ...
 shiftSchema.method({
  transform(date) {
    const transformed = {};
    const fields = ['id', 'userId','startTime','contact','endTime', 'inOut','siteId','casualShiftId' ,'shiftDate','clockInTime','clockOutTime', 'latitude', 'longitude','breaks','createdBy', 'groupId','isGroup','createdAt'];
